...
| File | Use |
|---|---|
| `description.bbcode` | The Workshop page body. Steam uses BBCode, not Markdown — paste it as-is. |
...
so put it first — Steam shows the first screenshot most prominently.

## Keep in sync

The description duplicates facts from the root `README.md` — requirements, the
